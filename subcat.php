...
<head>
    ...
    <title>Trip Booking Platform SubCategory</title>
 <!--Bootstrap Core CSS -->
...
<?php
$cn=mysqli_connect("localhost","root","","trip");
$s="select * from subcategory where CategoryId='" .$_GET["catid"] . "'";
$result=mysqli_query($cn,$s);
$r=mysqli_num_rows($result);
//echo $r;
$n=0;
...
<?php
                        ...
                        <td>
                            <table border="0" width="100px" bordercolor="#FF6666">
                                ...
                                <tr>
                                    <td align="center" style="background-color:#60B0E6; font-family:Lucida Calligraphy"><a href="package.php?subcatid=<?php echo $data[0];?>"><font color="#FFFFFF">View Detail</font></a></td>
                                </tr>
                            </table>
                        </td>
<?php
