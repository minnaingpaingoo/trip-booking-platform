...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2023 at 07:09 PM
...
INSERT INTO `admin` (`UserName`, `Password`, `Type`, `AdminName`, `Email`, `Phone`, `Picture`, `Status`, `RegDate`) VALUES
('admin', 'admin', 'Admin', 'Min Naing Paing Oo', 'npo@gmail.com', 9790663667, 'avatar15.jpg', 1, '2023-07-22 15:51:44'),
('APK', '12345', 'Admin', 'Aung Phyo Kyaw', 'apk@gmail.com', 9123456789, 'avatar15.jpg', 1, '2023-07-26 01:38:45'),
('general', 'general', 'General', 'General', 'general@gmail.com', 9953995489, 'avatar15.jpg', 1, '2023-07-22 15:51:44'),
('mnpo', 'mnpo', 'Admin', 'MNPO', 'mnpo@gmail.com', 9953995489, 'avatar15.jpg', 1, '2023-07-22 15:51:44');
...
(8, 'Bamaw              ', 1, 1, 3990098, 'myeik.jpg', 'Kyaikhtiyoe.jpg', 'Island.jpg', 'trhwfgdffg');
...
--
ALTER TABLE `package`
  MODIFY `PackageId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `subcategory`
--
ALTER TABLE `subcategory`
  MODIFY `SubCatId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
